...
def functie_A():
    ...
    for i in range(100):
        ...
        microbit.pin0.write_analog(10*i)
        microbit.sleep(random.randint(20,50))
        microbit.pin2.write_analog(0)
        microbit.pin1.write_analog(1000-10*i)
        microbit.pin0.write_analog(10*i)
        microbit.sleep(random.randint(20,50))
...
def functie_B():
    # deze code mag je veranderen
    for i in range(100):
        microbit.pin2.write_analog(10*i)
        microbit.pin1.write_analog(0)
        microbit.pin0.write_analog(1000-10*i)
        microbit.sleep(20)
        microbit.pin2.write_analog(0)
        microbit.pin1.write_analog(1000-10*i)
        microbit.pin0.write_analog(1000-10*i)
...
def functie_AB():
    ...
    for i in range(100):
        ...
        microbit.sleep(random.randint(10,100))
        microbit.pin2.write_analog(random.randint(0,1000))
        microbit.pin1.write_analog(random.randint(0,1000))
        microbit.pin0.write_analog(random.randint(0,1000))
        microbit.sleep(i)
    microbit.display.clear()
    # tot hier
