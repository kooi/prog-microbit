...
def functie_A():
    microbit.pin0.write_analog(100)
    microbit.pin1.write_analog(255)
    microbit.pin2.write_analog(255)

    
def functie_B():
    microbit.pin0.write_analog(42)
    microbit.pin1.write_analog(70)
    microbit.pin2.write_analog(70)

    
def functie_AB():
    microbit.pin0.write_analog(167)
    microbit.pin1.write_analog(232)
    microbit.pin2.write_analog(232)
